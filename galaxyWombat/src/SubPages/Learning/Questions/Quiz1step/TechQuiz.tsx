  ...
  return (
    <div className="quiz-container p-4 mx-auto h-[100vh] flex justify-center items-center w-full bg-gray-800 text-center rounded-md">
      <div className='w-[65%] h-[55vh] flex flex-col justify-between'>
        <div>
          <h1 className="text-white text-4xl mb-10 font-bold tracking-[2px]">Quiz Technologiczny o {planet?.label}</h1>
        ...
        <div className='mt-1'>
          ...
          {showResult && selectedAnswer && selectedAnswer.isCorrect && (
            <button onClick={handleNextQuestion} className="block w-full mt-4 bg-green-500 text-white p-4 rounded-full border-2 border-gray-700 border-b-[4px] hover:bg-green-600 hover:border-green-500 active:border-b-2 active:translate-y-[2px] focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50">
